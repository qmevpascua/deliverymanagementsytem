...
class _HomeContentState extends State<HomeContent> {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      transform: Matrix4.translationValues(xOffset, yOffset, 0.0)..scale(scaleFactor),
              ...
              children: [
                ...
                isDrawerOpen
                    ...
                    : IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            xOffset = SizeConfig.getProportionateScreenHeight(230);
                            yOffset = SizeConfig.getProportionateScreenHeight(150);
                            scaleFactor = 0.6;
                            isDrawerOpen = true;
                          });
                        },
